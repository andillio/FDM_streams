...
def Plot6D(name,d):
	...
	np.save(d.dataDir + "phi1_deg.npy", phi1*rad2deg)
	np.save(d.dataDir + "phi2_deg.npy", phi2*rad2deg)
	np.save(d.dataDir + "r_kpc.npy", r)
	np.save(d.dataDir + "v_phi1.npy", v_phi1)
	np.save(d.dataDir + "v_phi2.npy", v_phi2)
	np.save(d.dataDir + "v_r.npy", v_r)
